...
<div align="center">
  <div style="max-width: 520px; width: 100%; padding: 16px; border-radius: 16px; background: linear-gradient(135deg, #fff7f0, #f1f7ff); box-shadow: 0 12px 32px rgba(0,0,0,0.08); border: 1px solid #efe8ff;">
    <p style="margin: 0 0 12px; font-weight: 800; font-size: 20px; letter-spacing: 0.2px; color: #1f2937;">🎬 B站 · shiaho</p>
    <a href="https://b23.tv/4AS5vB4" target="_blank" rel="noreferrer noopener" style="text-decoration: none; color: inherit;">
      <img src="./images/b站首页.png" alt="B站主页 - shiaho" style="width: 100%; border-radius: 12px; border: 1px solid #ececec;" />
    </a>
    <p style="margin: 12px 0 0; color: #374151; font-size: 14px;">295 粉丝 · 2 投稿 · 1098 获赞</p>
